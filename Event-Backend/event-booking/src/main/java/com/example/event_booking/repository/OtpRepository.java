...
import org.springframework.data.mongodb.repository.MongoRepository; // Change this
import org.springframework.stereotype.Repository;

import java.util.Optional;

@Repository
public interface OtpRepository extends MongoRepository<Otp, String> { // Change to MongoRepository and String for ID type
